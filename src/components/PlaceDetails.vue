<template>
  <div class="locationGeocoder demo">
    ...
    <div class="panes">
      <!-- Map -->
      <googlemaps-map class="map" :center.sync="center" :zoom="12" @click="onClick">
        <!-- User Position -->
        ...
        <template slot-scope="props">
          ...
          <div class="details" v-else-if="props.results">
            ...
            <div v-if="props.results.photos" class="photos">
              <div v-for="(photo, index) of props.results.photos" :key="index" class="photo">
            ...
            <div class="website" v-if="props.results.website">
              ...
              <a :href="props.results.website" target="_blank">{{ props.results.website }}</a>
            </div>
          </div>
